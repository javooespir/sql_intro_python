...
def modify(id, name):
    ...
    rowcount = c.execute(
        "UPDATE estudiante SET name=? WHERE id=?", (name, id)).rowcount
...
if __name__ == '__main__':
    ...
    # fill()
    fill('Alberto', 16, 4, 'Salina')
    fill('Anabelle', 18, 6, 'Gonzalez')
    fill('Chiara', 15, 3, 'Monte')
    fill('Omar', 17, 5, 'Sola')
    fill('Micaela', 13, 1, 'Carballo')
